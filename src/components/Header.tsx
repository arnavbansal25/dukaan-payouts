      ...
      <div className="flex flex-col items-center justify-between gap-4 px-8 py-3 md:flex-row md:gap-0 p-6 pt-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 group cursor-pointer">
            ...
            <p className="invisible absolute -left-16 top-10 py-0.5 px-2 rounded-sm bg-opacity-40 bg-black text-white text-xs group-hover:visible">
        ...
        <div className="flex items-center bg-darkGrayBg rounded-lg pl-4 py-2 w-1/3">
          <img src={searchIcon} alt="search-icon" />
          <input
            placeholder="Search features, tutorials, etc."
            className="bg-darkGrayBg border-none focus:outline-none pl-2 w-full"
          />
        </div>
